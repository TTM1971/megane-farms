...
def dashboard_personnel():
    ...
    return render_template('dashboard_personnel.html', username=current_user.username)
...
def dashboard_client():
    ...
    return render_template('dashboard_client.html', username=current_user.username)
