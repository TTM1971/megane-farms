...
# Route inscription
import re  # en haut de ton fichier app.py, ajoute cette importation pour utiliser les regex
...
def register():
    if request.method == 'POST':
        ...
        if not re.search(r'[A-Z]', password):
            flash('Le mot de passe doit contenir au moins une lettre majuscule.')
            return redirect(url_for('register'))
